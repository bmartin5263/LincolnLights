...
auto SingleRpmColorMode::calculateColor(const RpmGaugeCalculations& calcs, const RpmScene& scene) const -> rgb::Color {
...
auto BlendedRpmColorMode::calculateColor(const RpmGaugeCalculations& calcs, const RpmScene& scene) const -> rgb::Color {
...
auto PartitionedRpmColorMode::calculateColor(const RpmGaugeCalculations& calcs, const RpmScene& scene) const -> rgb::Color {
